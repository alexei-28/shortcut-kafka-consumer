package com.gmail.alexei28.shortcut.kafka.consumer.task5.consumer;

import com.gmail.alexei28.shortcut.kafka.consumer.task5.dto.UserDto;
import com.gmail.alexei28.shortcut.kafka.consumer.task5.service.UserService;
...
/*
   Задача 5 — «DLQ, но удобнее»
    ...
    Тесты: невалидное сообщение → запись в таблицу DLQ, ручной retry через REST, массовый retry
*/
@Service
public class UserConsumer {
  ...
  public void consume(
      ...
      UserDto userDto) {
    logger.info(
        "consume, received message with key: {}, topic: {}, groupId: {}, UserDto: {}",
        key,
        topic,
        groupId,
        userDto);
