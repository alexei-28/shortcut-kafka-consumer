...
public class DlqMessageUpdater {
  ...
  @Transactional
  public void markFailed(String key, String errorClass, String errorMessage) {
    dlqMessageRepository
        .findByEventId(key)
        .ifPresent(
            msg -> {
              ...
              msg.setErrorClass(errorClass);
              msg.setRetryCount(msg.getRetryCount() + 1);
            });
  }

  @Transactional
  public void markExhausted(String key, String errorClass, String errorMessage) {
    dlqMessageRepository
        .findByEventId(key)
        .ifPresent(
            msg -> {
